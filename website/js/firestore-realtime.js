...
window.BaqueanoFirestore = (function() {
  ...
  const SEED_PLACES = [
    ...
    {
      id: 'place_haydee_015',
      name: 'Restaurante Cocina Doña Haydée',
      department: 'Managua',
      municipality: 'Managua',
      category: 'gastronomia',
      description: 'Embajada de la gastronomía folclórica: vigorón, nacatamales, chancho con yuca, baho y postres tradicionales de maíz.',
      rating: 4.9,
      reviewCount: 920,
      cooperativeName: 'Maestras Tradicionales',
      imageUrl: 'assets/images/destinos/dona_haydee.jpg',
      badge: 'Cocina Autóctona',
