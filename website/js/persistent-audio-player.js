...
(function () {
  ...
  function render() {
    ...
    player.addEventListener('click', event => {
      ...
      if (action === 'expand') setMinimized(false);
  ...
  function enableDragging(player) {
    ...
    player.addEventListener('pointerdown', event => {
      const canDrag = player.classList.contains('is-minimized') || event.target.closest('[data-drag-handle]');
