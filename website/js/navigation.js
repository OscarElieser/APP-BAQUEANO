...
function loadBaqueanoDigital() {
  ...
  if (!document.querySelector('link[data-baqueano-assistant]')) {
    ...
    style.rel = 'stylesheet'; style.href = 'css/baqueano-assistant.css?v=20260925-baqui-5'; style.dataset.baqueanoAssistant = 'true';
    document.head.appendChild(style);
  }
  if (!document.querySelector('script[data-baqueano-assistant]') && !window.BaqueanoAssistant) {
    const script = document.createElement('script');
    script.src = 'js/baqueano-assistant.js?v=20260925-baqui-5'; script.defer = true; script.dataset.baqueanoAssistant = 'true';
