...
(function (window, document) {
  ...
  function reopen() { session.hidden = false; session.hiddenUntil = 0; session.minimized = false; state.minimized = false; saveSession(); root.classList.remove('is-snoozed', 'is-minimized'); wakeCharacter(); showSuggestion('Estoy de vuelta. Puedo recomendarte algo de esta sección o abrir el panel cuando vos decidás.'); track('assistant_reopened'); }
